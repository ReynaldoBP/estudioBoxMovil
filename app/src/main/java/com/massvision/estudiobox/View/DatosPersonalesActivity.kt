...
class DatosPersonalesActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (idEncuesta != null && titulo!= null && descripcion!= null && permiteFirma!= null && permiteDatoAdicional!= null && permiteCorreo!= null && permiteAnio!= null && permiteGenero!= null && tiempoDeEspera!= null && email!= null && idEmpresa!= null) {
            ...
            jsonParametrosTratamiento.addProperty("permiteCorreo", permiteCorreo)
            jsonParametrosTratamiento.addProperty("permiteAnio", permiteAnio)
            jsonParametrosTratamiento.addProperty("permiteGenero", permiteGenero)
