...
class PublicidadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //binding.buttonRegresar.setOnTouchListener(delayHideTouchListener)
        //binding.buttonRegresar.setOnClickListener { onBackPressed() }
        binding.buttonRegresar.setOnClickListener { finish() }
    }
